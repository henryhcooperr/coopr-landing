    ...
    <div className="min-h-screen bg-[hsl(220,20%,99%)]">
      ...
      <section className="pt-28 pb-24 px-6">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-[clamp(1.75rem,4vw,2.5rem)] font-semibold tracking-[-0.03em] text-[hsl(220,20%,10%)] mb-2">
            Terms of Service
          </h1>
          <p className="text-[14px] text-[hsl(220,10%,50%)] mb-10">
            Last updated: March 10, 2026
          </p>

          <div className="space-y-8 text-[15px] leading-relaxed text-[hsl(220,10%,30%)]">
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Agreement to terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Description of service</h2>
              <p>
                Coopr is an AI-powered content strategy platform that analyzes your social media content, provides performance predictions, and generates personalized recommendations. The Service integrates with third-party platforms such as Instagram through their official APIs.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Eligibility</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Your account</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Your content and data</h2>
              <p>
                You retain all ownership rights to your content. By connecting your social media accounts, you grant us a limited, non-exclusive license to access, analyze, and process your content solely for the purpose of providing the Service. We do not claim ownership of your content, creative identity profile, or AI-generated recommendations. You may revoke access to your social media accounts at any time.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Acceptable use</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Third-party integrations</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">AI-generated content</h2>
              <p>
                The Service uses artificial intelligence to generate recommendations, predictions, and analysis. These outputs are provided for informational purposes and should not be relied upon as guarantees of performance. Actual results may vary. You are solely responsible for decisions made based on the Service's recommendations.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Limitation of liability</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Disclaimer of warranties</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Termination</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Changes to terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Governing law</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Contact</h2>
              <p>
                Questions about these terms? Contact us at{' '}
                <a href="mailto:henry@getcoopr.com" className="text-[hsl(220,40%,35%)] underline underline-offset-2 hover:text-[hsl(220,20%,10%)] transition-colors">henry@getcoopr.com</a>.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-[hsl(220,10%,91%)] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <span className="text-[13px] text-[hsl(220,10%,30%)] font-medium">Terms</span>
