      ...
      <section className="pt-28 pb-24 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 text-[15px] leading-relaxed text-[hsl(220,10%,30%)]">
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Who we are</h2>
              <p>
                Coopr is operated by Lensofcoop LLC ("we", "us", "our"). We provide an AI-powered content strategy platform for creators. This policy explains how we collect, use, and protect your information.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Information we collect</h2>
              <p className="mb-3">
              ...
              <p className="mb-3">
                <span className="font-medium">Usage data.</span> We collect information about how you interact with Coopr, including features used, preferences set, and conversations with the AI assistant. This helps us improve the product.
              </p>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">How we use your information</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Your content stays yours</h2>
              <p>
                Your content data, creative preferences, and AI-generated insights belong to you. We do not use your individual content data to train models for other users. Your creative DNA profile and strategy recommendations are private to your account.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Third-party services</h2>
              <p>
                We integrate with social media platforms (such as Instagram) through their official APIs to access your content and engagement data. We also use third-party AI services to power our analysis features, and cloud hosting providers to store and process your data. Each third-party service is bound by its own privacy policy and our data processing agreements.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Data security</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Data retention and deletion</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Your rights</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Children's privacy</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Changes to this policy</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Contact us</h2>
              <p>
      ...
      <footer className="border-t border-[hsl(220,10%,91%)] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <span className="text-[13px] text-[hsl(220,10%,30%)] font-medium">Privacy Policy</span>
