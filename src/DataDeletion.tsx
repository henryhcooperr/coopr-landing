      ...
      <section className="pt-28 pb-24 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 text-[15px] leading-relaxed text-[hsl(220,10%,30%)]">
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Your right to deletion</h2>
              <p>
                You have the right to request deletion of all personal data and content data associated with your Coopr account at any time. This includes your profile information, connected social media data, content analysis results, creative DNA profile, and all AI-generated recommendations.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">How to request data deletion</h2>
              <p className="mb-4">
                To request deletion of your data, send an email to{' '}
                <a href="mailto:henry@getcoopr.com?subject=Data%20Deletion%20Request" className="text-[hsl(220,40%,35%)] underline underline-offset-2 hover:text-[hsl(220,20%,10%)] transition-colors">henry@getcoopr.com</a>{' '}
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">What gets deleted</h2>
              <p>
                Upon receiving your request, we will delete: your account information and login credentials, all content data collected from your connected social media accounts, your creative DNA profile and preference data, all AI-generated analysis and recommendations, conversation history with the Coopr assistant, and any other personal data associated with your account.
              </p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Timeline</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Facebook and Instagram data</h2>
              <p>
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-[hsl(220,20%,10%)] mb-2">Questions</h2>
              <p>
